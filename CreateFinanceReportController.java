 ...
 * @author DELL
 */
public class CreateFinanceReportController implements Initializable {
    ...
    @FXML
    private TableColumn<?, ?> ReportCreatedOn;
    ...
    @FXML
    private void EditFinanceReportOnClick(ActionEvent event) {
    }
